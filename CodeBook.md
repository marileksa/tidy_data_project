...
| 3 | Feature      | one of 66 feature variable names selected out of 561 items listed in "features.txt" based on information provided in "feature_info.txt"|tBodyAccMeanX|           .1| initial number from "features.txt"|
||||                tBodyAccMeanY|          .2|
||||                tBodyAccMeanZ|           .3|
||||                tBodyAccStdX|            .4|
||||                tBodyAccStdY|            .5|
